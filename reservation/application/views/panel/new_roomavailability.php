...
<head>
    ...
    <?php $this->load->view("panel/room_availability/add/page_style"); ?>
</head>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php $this->load->view("panel/room_availability/add/availability_add_main_content"); ?>
        </div>
        <!-- /.content-wrapper -->
    ...
    <?php $this->load->view("panel/room_availability/add/page_script"); ?>
</body>
