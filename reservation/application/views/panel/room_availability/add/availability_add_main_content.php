...
<section class="content">
    <div class="row">
        <div class="col-md-8">
            <!-- Date range -->
            <form action="<?php echo base_url("panel/room/addNewAvailability/$room_id"); ?>" method="post">
        ...
        <ul class="availability_table">
            ...
            ?>
                <li class="bg-<?php echo $color; ?>">
                    <?php echo $date->format("d") . "<br>" . get_month_from_eng($date->format("M")) . "<br>" . get_day_from_eng($date->format("D")) ?>
                </li>
            <?php } ?>
        </ul>
    </div>
