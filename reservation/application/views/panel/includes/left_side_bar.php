            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu" id="room_folder">
                    <li class="<?php echo ($activeItem == "room_category") ? "active" : ""; ?>" id="room_category">
                        <a href="<?php echo base_url("panel/roomcategory"); ?>"><i class="fa fa-circle-o"></i> Kategoriler</a>
                    </li>
                    <li class="<?php echo ($activeItem == "room") ? "active" : ""; ?>" id="room">
                        <a href="<?php echo base_url("panel/room"); ?>"><i class="fa fa-circle-o"></i> Odalar</a>
                    </li>
                    <li class="<?php echo ($activeItem == "room_properties") ? "active" : ""; ?>" id="room_properties">
                        <a href="<?php echo base_url("panel/roomproperties"); ?>"><i class="fa fa-circle-o"></i> Özellikler</a>
                    </li>
                    <li class="<?php echo ($activeItem == "room_extra_services") ? "active" : ""; ?>" id="room_extra_services">
                        <a href="<?php echo base_url("panel/roomextraservices"); ?>"><i class="fa fa-circle-o"></i> Ekstra Servisler</a>
                    </li>
                </ul>
            </li>
        </ul>
