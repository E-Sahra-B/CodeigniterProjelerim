                        ...
                        <tbody class="sortableList" postUrl="roomproperties/rankUpdate">
                            <?php foreach ($rows as $row) { ?>
                                <tr id="sortId-<?php echo $row->id; ?>" class="btn-move">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url("roomproperties/editPage/$row->id"); ?>" data-toggle="tooltip" data-placement="top" title="Düzenle">
                                            <i class="fa fa-edit fa-lg"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="<?php echo base_url("roomproperties/delete/$row->id"); ?>" data-toggle="tooltip" data-placement="top" title="Sil">
